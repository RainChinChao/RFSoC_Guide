...
(* CORE_GENERATION_INFO = "bd_49ec,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_49ec,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=47,numReposBlks=37,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_1_smartconnect_0_3.hwdef" *) 
module bd_49ec
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m02_exit_pipeline_imp_S6FQH4 m02_exit_pipeline
  ...
  m02_nodes_imp_1XIE0UH m02_nodes
...
module m02_exit_pipeline_imp_S6FQH4
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
